                  ...
                  <div className="author">
                    ...
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      <img
                        alt="..."
                        className="avatar"
                        src="https://avatars1.githubusercontent.com/u/45796208?s=460&u=bac387fb3521d4514d266a39c7274abc00aafadc&v=4"
                      />
                      <h5 className="title">Hemang Nakarani</h5>
                    </a>
                  </div>
                </CardBody>
                <CardFooter>
                  ...
                  <div className="author">
                    ...
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      <img
                        alt="..."
                        className="avatar"
                        src="https://avatars1.githubusercontent.com/u/32960257?s=460&u=5a6339c8087716895ad5b22f62124e95753f368f&v=4"
                      />
                      <h5 className="title">Abhinav Raj</h5>
                    </a>
                  </div>
                </CardBody>
                <CardFooter>
                ...
                <CardBody>
                  ...
                  <div className="author">
                    ...
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      ...
                      />
                      <h5 className="title">Rahil Shah</h5>
                    </a>
                  </div>
                </CardBody>
                <CardFooter>
